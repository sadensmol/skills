...
can restore it, e.g. a zoom that hides the sidebar and must re-show it only when it was
...
command name per line, seeded with terminal multiplexers). It is a plain
